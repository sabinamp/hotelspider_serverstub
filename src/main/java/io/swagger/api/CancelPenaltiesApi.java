...
@Api(value = "cancel-penalties", description = "the cancel-penalties API")
public interface CancelPenaltiesApi {

    @ApiOperation(value = "get the cancellation penalties for a given stay", nickname = "cancelPenaltiesLangHotelIdGet", notes = "", response = String.class, authorizations = {
        @Authorization(value = "api_key")
    }, tags={ "Cancellation policies and penalties", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Return a summary of the cancellation penalties that applies to the specified product at the specified dates", response = String.class),
